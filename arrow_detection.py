...
class RealtimeArrowDetectionNode:
    def __init__(self):
        ...
        self.model = self.load_saved_model('./efficient_model')  # Update with your actual model path
        self.bridge = CvBridge()

        self.image_sub = rospy.Subscriber('/zed2i/zed_node/rgb/image_rect_gray', Image, self.image_callback) #Update with Zed2i topic 
